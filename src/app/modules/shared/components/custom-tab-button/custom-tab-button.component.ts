...
export class CustomTabButtonComponent {
  ...
  classDiv1Selected: string = 'flex flex-col w-max items-center justify-center';
  classDiv1NotSelected: string = 'flex flex-col w-max items-center justify-center hover:bg-primary-50 hover:border hover:border-primary-50 hover:rounded-md cursor-pointer';
