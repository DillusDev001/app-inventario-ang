...
@Component({
  selector: 'app-custom-input-2-dark',
  templateUrl: './custom-input-2-dark.component.html',
  styleUrls: ['./custom-input-2-dark.component.css']
})
export class CustomInput2DarkComponent {
  @Input() id!: string;
  @Input() label!: string;
  @Input() type!: string;
