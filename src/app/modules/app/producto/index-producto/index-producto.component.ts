...
import { goProducto_Agregar, goProducto_Lista } from 'src/app/common/utils/app/producto/producto.router';
...
export class IndexProductoComponent implements OnInit {
  ...
  onClickButton(value: string) {
    switch (value) {
      ...
      case 'Artículos':
        goProducto_Lista(this.router);
        this.selectedTab = value;
        break;

      case 'Agregar':
        goProducto_Agregar(this.router);
        this.selectedTab = value;
        break;
    }
  }
